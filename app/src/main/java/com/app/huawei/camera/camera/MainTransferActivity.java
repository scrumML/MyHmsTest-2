...
public class MainTransferActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!allPermissionsGranted()) {                                                 //检查相机的权限
    ...
    private void translatePhoto() {                                                     //todo 打开翻译页面
    ...
    public void onClick(View v) {
        switch (v.getId()) {                                                                //todo 选择语言 ，翻译图片
            case R.id.buttonSwitchLang:   //todo 选择语言
                MainTransferActivity.this.doLanguageSwitch();
                break;
            case R.id.select_photo: //todo 点击翻译图片
