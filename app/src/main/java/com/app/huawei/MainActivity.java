...
import com.app.huawei.face.StillFaceAnalyseActivity;
...
*  Image Face
* */
    public void ImageFaceBtnClick(View view) {
        startActivity(new Intent(MainActivity.this, StillFaceAnalyseActivity.class));
    }
    ...
    /**
     * Call IDCardRecognitionActivity.
     */
    ...
    /**
     * Call MainTransferActivity
     */
    public void loadTextRecognitionPicBtnClick(View view){
        // Picture-Text recognition and translation
